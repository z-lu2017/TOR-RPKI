...
def user_specified_client2(consensus_date, year, month, date):
    '''
...
def run_sim():
        ...
        for m in months2:
            ...
            for d in days:
                ...
                for h in hours:
                    ...
                    missing = user_specified_client2(consensus_date_with_hour, y, m, d)
    ...
    d = {'date': date_strings, 'case': case_strings, 'missing': m1}
    df = pd.DataFrame(data = d)
    df.to_csv("./countries-dist-Jan-April2023.csv", index=False)
